...
//    fun getListObject(key: String?, mClass: Class<ModelSaudara>?): ArrayList<ModelSaudara> {
//        val gson = Gson()
//        val objStrings = getListString(key)
//        val objects = ArrayList<ModelSaudara>()
...
//    }
     ...
     */
    open fun putObject(key: String?, obj: Any?) {
        checkForNullKey(key)
        val gson = Gson()
    ...
    init {
        preferences = appContext?.getSharedPreferences("Db",Context.MODE_PRIVATE) as SharedPreferences
    }
}
